...
Include [Bootstrap v5.3.3](https://getbootstrap.com) CSS & JS together with [Bootstrap Icons v1.11.3](https://icons.getbootstrap.com) via the [jsDelivr CDN](https://www.jsdelivr.com/package/npm/bootstrap).
