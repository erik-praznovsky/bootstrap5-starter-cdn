...
Include [Bootstrap v5.3.7](https://getbootstrap.com) CSS & JS together with [Bootstrap Icons v1.13.1](https://icons.getbootstrap.com) via the [jsDelivr CDN](https://www.jsdelivr.com/package/npm/bootstrap).
